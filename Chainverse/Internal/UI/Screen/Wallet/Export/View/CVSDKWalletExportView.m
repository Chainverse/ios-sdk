...
- (void)initUI{
    ...
    self.lblAddress.text = [[CVSDKBridgingWallet shared]importWallet:[CVSDKUserDefault getMnemonic]];
    ...
    self.lblPrivateKey.text = [[CVSDKBridgingWallet shared] getPrivateKey];
...
- (void)didTapCopyAddress:(UITapGestureRecognizer *)tapGesture {
    ...
    pasteboard.string = [[CVSDKBridgingWallet shared] importWallet:[CVSDKUserDefault getMnemonic]];
}

- (void)didTapCopyPrivateKey:(UITapGestureRecognizer *)tapGesture {
    self.viewCopiedPrivateKey.hidden = NO;
    UIPasteboard *pasteboard = [UIPasteboard generalPasteboard];
    pasteboard.string = [[CVSDKBridgingWallet shared] getPrivateKey];
}
