...
extension web3 {
    ...
    public class web3contract {
        ...
        //NamPV Custom
        public func encodeFunction(_ method:String = "fallback", parameters: [AnyObject] = [AnyObject](), extraData: Data = Data(), transactionOptions: TransactionOptions? = nil) -> String {
            guard let tx = self.contract.encodeFunction(method, parameters: parameters, extraData: extraData) else {return ""}
            return tx
        }
